...
artist_fixes <- c("Blink 182" = "Blink-182", "Guns 'n Roses" = "Guns N' Roses", "Ac/dc" = "AC/DC", "P.o.d." = "P.O.D.", "R.e.m." = "R.E.M.", "A.f.i." = "A.F.I.", "Afi" = "A.F.I.", "The Smashing Pumpkins" = "Smashing Pumpkins", "Guns N Roses" = "Guns N' Roses")
